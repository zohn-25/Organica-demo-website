...
export function MobileBottomNav({
  ...
  return (
    <div className="block md:hidden fixed bottom-0 left-0 right-0 z-40 select-none pb-safe">
      ...
      <div className="bg-[#FAF8F3]/95 backdrop-blur-xl border-t border-[#E8E3D8] px-6 py-2.5 shadow-[0_-8px_24px_rgba(20,20,18,0.06)]">
        <div className="flex items-center justify-between max-w-sm mx-auto">
          ...
          >
            ...
            <span className="text-[10px] font-body font-bold">Home</span>
          </button>
          ...
          >
            ...
            {favoritesCount > 0 && (
              <span className="absolute top-0 right-1 w-4 h-4 rounded-full bg-[#B53424] text-white text-[9px] font-bold flex items-center justify-center">
                {favoritesCount}
              </span>
            )}
            <span className="text-[10px] font-body font-bold">Favorite</span>
          </button>
          ...
          >
            ...
            {totalCount > 0 && (
              <span className="absolute top-0 right-1 w-4.5 h-4.5 rounded-full bg-[#F2B705] text-[#141412] text-[10px] font-extrabold flex items-center justify-center shadow-xs">
                {totalCount}
              </span>
            )}
            <span className="text-[10px] font-body font-bold">Order</span>
          </button>
          ...
          >
            ...
            <span className="text-[10px] font-body font-bold">Kitchen</span>
          </button>
        </div>
      </div>
    </div>
